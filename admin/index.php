...
<html lang="en">
  ...
  <body>
	  <div id="login-page">
		...
		<div id="wrapper">
		  <div id="container">
			<div><input id="button" type="button" value="Back To Main Page" onClick="parent.location='http://localhost/UserLoginRegi/Admin-User-Login-Regis/User/index.php'"></div>
		  </div>
		  <div class="clear"> </div>
		</div>
	  </div>

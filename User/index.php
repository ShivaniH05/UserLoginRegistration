	 ...
	 <div class="sap_tabs">	
			...
			<div class="resp-tabs-container">
					...
					<div class="facts">
						...
						<div class="register">
							<form name="registration" method="post" action="#" enctype="multipart/form-data" name="form">
								<p>First Name </p>
								<input type="text" onKeyPress="return ValidateAlpha(event);" class="text" value="<?php if(isset($fname)){echo ($fname);} ?>"  name="fname" required >
								<p>Last Name </p>
								<input type="text" onKeyPress="return ValidateAlpha(event);" class="text" value="<?php if(isset($lname)) {echo ($lname);} ?>" name="lname"  required >
								<p>Email Address </p>
								<input type="text" class="text" value="<?php if(isset($email)){echo ($email); }?>" name="email" onblur="validateEmail(this);" >
								<p>Password </p>
								<input type="password" value="" id="password" name="password" onkeyup="CheckPasswordStrength(this.value)" required >
								<span id="password_strength"></span>
								<p>Confirm Password</p>
								<input type="password" value="" name="cpassword" required>
								<p>Contact No. </p>
								<input type="text" onkeypress='validate(event)' value="<?php if(isset($contact)){echo ($contact);} ?>" name="contact" maxlength="10" minlength="10" required >
								<div class="sign-up">
